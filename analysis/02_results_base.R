# Reproduce Results: Base Model
# Corresponds to: VE_model_2025_10_08.R / Vaccine_results_2025_11_28.R / TextResults_2025_10_08.R
...
# Settings
sims <- 1000 # Demo size (Use 5000 for full reproduction)
fastprogon <- 0
popsize <- 1500
...
for (cohort_name in names(cohorts)) {
    ...
    cat(paste0("Running Base Model Scenarios for ", cohort_name, "...\n"))
    ...
    filename <- paste0("figures/02_Base_VE_", qft_code, ".pdf")
